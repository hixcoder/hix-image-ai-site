...
export default function Prompt() {
  return (
    <div className="flex flex-col items-left w-3/5 h-fit bg-slate-50 p-6 rounded-lg">
      ...
      <button className="bg-blue-600 focus:ring-2 ring-blue-300 hover:bg-blue-500 w-fit text-white px-8 py-3 border-2 border-transparent rounded-md text-md my-5 hover:shadow-[0_0_10px_1px_rgba(59,130,246,0.5)]  animate-bounce hover:animate-none">
        Generate{" "}
      </button>
    </div>
  );
